    ...
    abstract class Form {
        ...
        public function setText(array $textList) {
            ...
            foreach($textList as $key => $value){
                $chaineText .= "<div><input type='" . $value . "' name='" . $key . "'></div>";
            }
        ...
        public function showForm(){
            return "<form action='" . $this->getAction() . "' method='" . $this->getMethod() ."' >" . $this->getText() . $this->getSubmit() . $this->getRadio() . $this->getCheckBox() . "</form>";
        }
